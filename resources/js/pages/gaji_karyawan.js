...
const createManualRowHTML = (isModal = false) => {
    ...
    return `
        <tr class="manual-item-row bg-white sm:bg-transparent border border-slate-200 sm:border-0 rounded-xl sm:rounded-none p-3 sm:p-0 mb-3 sm:mb-0 shadow-sm sm:shadow-none flex flex-col sm:table-row transition-colors hover:bg-slate-50 relative">
            <td class="block sm:table-cell p-0 sm:p-2 align-middle mb-2 sm:mb-0">
                <label class="block sm:hidden text-[10px] font-bold text-slate-500 uppercase mb-1">Kelompok</label>
                <select name="manual_kelompok[]" class="manual-kelompok border border-slate-200 rounded-lg text-xs bg-white p-2 sm:p-1.5 focus:ring-1 focus:ring-indigo-500 w-full transition">
            ...
            <td class="block sm:table-cell p-0 sm:p-2 align-middle mb-2 sm:mb-0">
                ...
                <input type="text" name="manual_deskripsi[]" placeholder="Deskripsi Komponen" class="manual-deskripsi border border-slate-200 rounded-lg text-xs bg-slate-50/50 p-2 sm:p-1.5 focus:bg-white focus:ring-1 focus:ring-indigo-500 w-full transition" required>
            </td>
            <td class="block sm:table-cell p-0 sm:p-2 align-middle mb-2 sm:mb-0">
                <label class="block sm:hidden text-[10px] font-bold text-slate-500 uppercase mb-1">Nominal</label>
                <input type="text" name="manual_nominal[]" placeholder="Rp 0" class="manual-nominal input-rupiah border border-slate-200 rounded-lg text-xs bg-slate-50/50 p-2 sm:p-1.5 focus:bg-white focus:ring-1 focus:ring-indigo-500 text-right font-bold text-slate-700 w-full transition" required>
            </td>
            <td class="block sm:table-cell p-0 sm:p-2 align-middle text-center mt-2 sm:mt-0 border-t sm:border-t-0 pt-2 sm:pt-0 border-slate-100">
                <button type="button" class="${hapusClass} text-rose-500 hover:text-rose-700 hover:bg-rose-50 p-2 sm:p-1.5 rounded-lg transition-all w-full sm:w-auto border border-rose-100 sm:border-transparent flex justify-center items-center gap-2 mx-auto">
