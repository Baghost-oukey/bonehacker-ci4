...
<div class="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto space-y-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div class="flex justify-between">
            <div id="reportrange" class="flex items-center gap-3 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-bold text-slate-600 cursor-pointer transition-all min-w-60 justify-between mr-5">
