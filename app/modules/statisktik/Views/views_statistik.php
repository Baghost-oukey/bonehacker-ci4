...
<div class="p-4 sm:p-6 md:p-8 max-w-350 mx-auto">
    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
            <h1 class="text-2xl font-black text-slate-800 tracking-tight">Riwayat Pasien</h1>
            <p class="text-sm text-slate-500 mt-1">Analisis volume kunjungan dan pertumbuhan pasien lintas wilayah.</p>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mx-7 mb-8">
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 border-l-4 border-l-slate-700 relative overflow-hidden group hover:border-slate-300 transition-all hover:-translate-y-1 hover:shadow-md">
        ...
        <h3 class="text-4xl font-black text-slate-800 tracking-tight" id="totalCount">55</h3>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 border-l-4 border-l-emerald-500 hover:border-emerald-300 transition-all hover:-translate-y-1 hover:shadow-md">
        ...
        <div class="flex flex-col items-start gap-2">
            <h3 class="text-4xl font-black text-slate-800 tracking-tight" id="newPatientsCount">9</h3>
            <div class="inline-flex items-center px-2.5 py-1 rounded-md text-[10px] font-black bg-emerald-50 text-emerald-700 border border-emerald-200 uppercase tracking-wider" id="percBaru">16.4% Pasien Baru</div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 border-l-4 border-l-indigo-500 hover:border-indigo-300 transition-all hover:-translate-y-1 hover:shadow-md">
        ...
        <div class="flex flex-col items-start gap-2">
            <h3 class="text-4xl font-black text-slate-800 tracking-tight" id="oldPatientsCount">16</h3>
            <div class="inline-flex items-center px-2.5 py-1 rounded-md text-[10px] font-black bg-indigo-50 text-indigo-700 border border-indigo-200 uppercase tracking-wider" id="percLama">29.1% Pasien Lama</div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 border-l-4 border-l-amber-500 hover:border-amber-300 transition-all hover:-translate-y-1 hover:shadow-md">
        ...
        <h3 class="text-4xl font-black text-slate-800 tracking-tight" id="avgPerDay">1.8</h3>
        <p class="text-[11px] font-bold text-slate-400 mt-2 uppercase tracking-tight">Pasien per Hari</p>
    </div>
</div>


<!-- TABLE KETERANGAN PASIENT -->
<div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden transition-all hover:shadow-md">
    <div class="p-6 border-b border-slate-100 bg-white flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <select id="region_id" class="bg-slate-50 border border-slate-200 text-slate-700 text-xs font-bold rounded-xl px-4 py-2.5 outline-none cursor-pointer focus:ring-2 focus:ring-indigo-500/20 w-full sm:w-62.5">
...
<div class="flex flex-col gap-8">
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden transition-all hover:shadow-md">
        <div class="p-6 border-b border-slate-100 bg-white flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div id="reportrange" class="flex items-center gap-3 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-bold text-slate-600 cursor-pointer transition-all min-w-60 justify-between">
...
<script>
    // Bridge Konfigurasi tanpa mengubah logika JS utama
