...
<section id="patientShowPage" class="w-full space-y-6 p-4 md:p-6">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500">Biodata, Riwayat, dan File Pasien — Jasa Pelayanan Reguler</p>
        </div>
    ...
    <div class="space-y-6">
        ...
        <!-- RIWAYAT (Regular - tanpa kejantanan) -->
        <div id="tab-riwayat">
            <?= $this->include('App\modules\jasa_pelayanan\Views\detailRegular\components\card_riwayat_regular') ?>
        </div>
