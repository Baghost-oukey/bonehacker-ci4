...
<section id="jasaPelayananPage" class="w-full space-y-6 p-4 md:p-6">
    ...
    <div class="rounded-2xl bg-white shadow-sm border border-slate-200/50 overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table id="table-JaspelPerHari" class="w-full text-sm hidden md:table">
                        ...
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <?php if (in_array($sess_role, ['superadmin', 'owner'])): ?>
                                <td class="px-6 py-4 text-center">
                                    <a href="<?= site_url('jasa-pelayanan/settings') ?>?region_id=<?= $setting->region_id ?>&tipe=reguler"
            ...
            <?php foreach ($settings as $setting): ?>
                ...
                <div class="p-4 space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <?php if (in_array($sess_role, ['superadmin', 'owner'])): ?>
                            <a href="<?= site_url('jasa-pelayanan/settings') ?>?region_id=<?= $setting->region_id ?>&tipe=reguler"
                                class="inline-flex items-center gap-1 rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-600 hover:bg-blue-100">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                        <?php endif; ?>
                    </div>
                    <div class="grid grid-cols-2 gap-2 text-xs border-t border-slate-50 pt-2.5">
                        <div class="flex flex-col gap-0.5">
                            ...
                            <span class="text-sm font-bold text-teal-600">Rp <?= number_format($setting->nominal_per_pasien, 0, ',', '.') ?></span>
                        </div>
                        <div class="flex flex-col gap-0.5">
